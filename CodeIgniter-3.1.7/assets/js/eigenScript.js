...
function aanpassenActiviteit(activiteit, id, voorPersoon, site_url) {
    ...
    function (data) {
        ...
        opvullenModalActiviteitAanpassen(data, activiteit, voorPersoon, site_url);
        console.log('ok3');
...
function opvullenModalActiviteitAanpassen(data, activiteit, voorPersoon, site_url) {
    ...
    switch (true) {
        case activiteit === "Wedstrijd":
            $('#aanpassenFormulier').attr('action', site_url + '/Trainer/Agenda/registreerWedstrijd');
