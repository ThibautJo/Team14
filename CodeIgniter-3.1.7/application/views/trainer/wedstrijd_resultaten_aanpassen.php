...
function datumSelect(){
  switch($("#datumSelected").val()) {
    case "0":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=0&jaar='.$jaar); ?>';
    break;
    case "1":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=1&jaar='.$jaar); ?>';
    break;
    case "2":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=2&jaar='.$jaar); ?>';
    break;
    case "3":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=3&jaar='.$jaar); ?>';
    break;
    case "4":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=4&jaar='.$jaar); ?>';
    break;
    case "5":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=5&jaar='.$jaar); ?>';
    break;
    case "6":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=6&jaar='.$jaar); ?>';
    break;
    case "7":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=7&jaar='.$jaar); ?>';
    break;
    case "8":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=8&jaar='.$jaar); ?>';
    break;
    case "9":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=9&jaar='.$jaar); ?>';
    break;
    case "10":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=10&jaar='.$jaar); ?>';
    break;
    case "11":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=11&jaar='.$jaar); ?>';
    break;
    case "12":
    window.location.href = '<?php echo site_url('/Trainer/WedstrijdResultaten/index?pagina=aanpassen&maand=12&jaar='.$jaar); ?>';
    break;
    default:
    break;
  }
