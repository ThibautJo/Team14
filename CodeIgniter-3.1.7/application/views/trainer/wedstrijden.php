...
<div id="wedstrijd">
  ...
  if (isset($_GET['maand'])) {
    ?>
    <button type="button" class="btn button-blue justify-content-center" onclick="document.location.href= site_url + '/Trainer/wedstrijden/index?pagina=aanpassen&maand=<?php echo $_GET['maand']."&jaar=".$_GET['jaar'] ?>'">Aanpassen</button>
    <?php
  }
  else {
    ?>
